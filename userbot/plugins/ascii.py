...
async def _(event):
    ...
    if reply_message.sender.bot:
        ...
        return
    eviral = await edit_or_reply(event, "Wait making ASCII...🤓🔥🔥")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await eviral.edit("`Please unblock @asciiart_bot and try again`")
            return
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await eviral.edit("Please unblock @Lines50Bot and try again")
            return
        await eviral.delete()
        await event.client.send_file(
            event.chat_id,
