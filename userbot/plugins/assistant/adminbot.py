...
@firebot.on(events.NewMessage(pattern="^/bun(?: |$)(.*)"))
async def ban(event):
...
@firebot.on(events.NewMessage(pattern="^/unbun(?: |$)(.*)"))
...
@firebot.on(events.NewMessage(pattern="^/prumote(?: |$)(.*)"))
...
@firebot.on(events.NewMessage(pattern="^/demute(?: |$)(.*)"))
...
@firebot.on(events.NewMessage(pattern="^/pin(?: |$)(.*)"))
async def pin(event):
    userids = []
    noob = event.sender_id
    async for user in firebot.iter_participants(
