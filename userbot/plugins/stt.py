...
async def _(event):
    ...
    eviralevent = await edit_or_reply(event, "Downloading to my local, for analysis  🙇")
    if event.reply_to_msg_id:
        ...
        if (
            ...
            await eviralevent.edit("Starting analysis, using IBM WatSon Speech To Text")
            headers = {
            ...
            if "results" in r:
                ...
                await eviralevent.edit(string_to_show)
            else:
                await eviralevent.edit(r["error"])
