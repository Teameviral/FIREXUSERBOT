...
@FIREX.on(admin_cmd(pattern=r"unpack", outgoing=True))
@FIREX.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@FIREX.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@FIREX.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
