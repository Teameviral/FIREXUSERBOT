...
@FIREX.on(admin_cmd(pattern="sin ?(.*)"))
@FIREX.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="cos ?(.*)"))
@FIREX.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="tan ?(.*)"))
@FIREX.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="cosec ?(.*)"))
@FIREX.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="sec ?(.*)"))
@FIREX.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="cot ?(.*)"))
@FIREX.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="square ?(.*)"))
@FIREX.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@FIREX.on(admin_cmd(pattern="cube ?(.*)"))
@FIREX.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
